  ...
  export default {
    ...
    data() {
      return {
        advisors: [
          {
            //sample advisor, add/edit more advisors as needed
            id: 1,
            name: 'John Doe',
